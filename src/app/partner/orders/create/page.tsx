...
export default function CreateOrderPage() {
  ...
  const handleSubmitOrder = async (e: React.FormEvent) => {
    ...
    if (!isEnglishOnly(customerName) || !isEnglishOnly(shippingAddress)) {
      toast({
        variant: "destructive",
    ...
    try {
      ...
      const orderData = {
        partnerId: currentUser?.partnerId || currentUser?.partner_id || currentUser?.id || currentUser?._id || 'unknown',
      ...
      if (response.ok) {
        toast({
          ...
          description: "Your order has been saved. Please review and approve it.",
        });
